...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nearbyUsers = __webpack_require__(38);

	var _nearbyUsers2 = _interopRequireDefault(_nearbyUsers);
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { type: 'button', className: 'navbar-toggle collapsed', 'data-toggle': 'collapse', 'data-target': '#collapse-menu', 'aria-expanded': 'true' },
	              React.createElement(
	                'span',
	                { className: 'sr-only' },
	                'Toggle navigation'
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    ReactRouter.Route,
	    { path: '/', component: App },
	    React.createElement(ReactRouter.Route, { path: 'login', component: _login2.default }),
	    React.createElement(ReactRouter.Route, { path: 'register', component: _register2.default }),
	    React.createElement(ReactRouter.Route, { path: 'home', component: _home2.default }),
	    React.createElement(ReactRouter.Route, { path: 'nearby', component: _nearbyUsers2.default })
	  )
	), destination);
	;
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement("input", { type: "text", className: "form-control", value: this.state.username, controlled: true, onChange: this.inputName })
	        ),
	        _react2.default.createElement(
	          "div",
	          { className: "form-inline" },
	          ...
	          _react2.default.createElement("input", { type: "password", className: "form-control", value: this.state.password, controlled: true, onChange: this.inputPassword })
	        ),
	        _react2.default.createElement(
	          "div",
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NearbyUsers = _react2.default.createClass({
	  displayName: 'NearbyUsers',
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  null,
	                  'Prefers ~',
	                  nearbyUser.profile.distance,
	                  ' miles at ',
	                  nearbyUser.profile.pace,
	                  ' min/mile'
	                ),
	                _react2.default.createElement(
	                  'p',
	                  null,
	                  'Approximately ',
	                  nearbyUser.separation,
	                  ' miles ',
	                  nearbyUser.direction
	                )
	              )
	            )
	          );
